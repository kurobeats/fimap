...
class autoawesome(baseClass):
    ...
    def scan(self):
        ...
        extHeader = ""
        code, headers = self.doRequest(
            self.URL, self.config["p_useragent"], self.config["p_post"], self.config["header"], self.config["p_ttl"])
        ...
        for form in soup.findAll("form"):
            ...
            for input in form.findAll("input"):
                if ("name" in input):
                    ...
                    print(
                        "An input field doesn't have an 'name' attribute! Skipping it.")
