...
class TempFileAbuse(basePlugin):
    ...
    def plugin_fallback_modes_requested(self, langClass):
        ...
        if (langClass.getName() == "PHP"):
            self.lang = langClass
            ret.append(
                ("Launch Coldwind/Insomnia Glitch...", "TempFileAbuse.hax"))
    ...
    def plugin_callback_handler(self, callbackstring, haxhelper):
        if (callbackstring == "TempFileAbuse.hax"):
            ...
            while(inp != "q" and inp != "Q"):
                ...
                options.append(
                    "6. Change number of trash to append (Current: %s)" % (self.trashFactor))
                ...
                try:
                    ...
                    if (idx == 1):
                        self.phpinfourl = input(
                            "Please type in the complete URL of the PHPInfo() file: ")
                    ...
                    if (idx == 5):
                        ...
                        tmp = input(
                            "Please type in the number of trash to append: ")
                        try:
                            n = int(tmp)
                            if (n < 0):
